...
import datos.MapaNombres;

/**
 *
 * @author eduar
 */
public class MapaFrameNombres extends javax.swing.JFrame {

    /**
     * Creates new form ListasFrame
     */
    public MapaFrameNombres() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Mapa [Nombres] by Eduardo");
    ...
    private void seleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionarActionPerformed
        ...
        if (index == 0) {
            listaContenidoOrdenar.setText(MapaNombres.getContenido());
        } else {
            listaContenidoOrdenar.setText(MapaNombres.reverseContenido());
        }
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        if (nombre_buscar.trim().length() > 0) {
            int encuentro = MapaNombres.buscarNombre(nombre_buscar);
            if (encuentro != -1) {
                salidaBuscar.setText("El nombre " + nombre_buscar + "se encuentra en la clave "+encuentro);
            } else {
                salidaBuscar.setText("El nombre no se encuentra en el mapa.");
            }
    ...
    private void registro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registro1ActionPerformed
        String contenido = MapaNombres.getContenido();
    ...
    private void registroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registroActionPerformed
        ...
        String clave = ingresoPrecio.getText();
        int numero = 0;
        try {
            numero = Integer.parseInt(clave);
            if (nombre.trim().length() > 0) {
                MapaNombres.addNombre(nombre, numero);
            ...
            salida.setText("La clave no es válida.");
        }
...
//
//    /**
//     * @param args the command lisne arguments
//     */
