...
import datos.MapaProductos;

/**
 *
 * @author eduar
 */
public class MapaFrameProducto extends javax.swing.JFrame {

    /**
     * Creates new form ListasFrame
     */
    public MapaFrameProducto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Mapas [Productos] by Eduardo");
    ...
    private void seleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionarActionPerformed
        ...
        if (index == 0) {
            listaContenidoOrdenar.setText(MapaProductos.getContenido());
        } else {
            listaContenidoOrdenar.setText(MapaProductos.reverseContenido());
        }
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        if (nombre_buscar.trim().length() > 0) {
            String encuentro = MapaProductos.buscarNombre(nombre_buscar);
            if (encuentro != null) {
                salidaBuscar.setText("El nombre " + nombre_buscar + " contiene la clave: " + encuentro);
            } else {
                salidaBuscar.setText("El producto no se encuentra en el mapa.");
            }
    ...
    private void registro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registro1ActionPerformed
        String contenido = MapaProductos.getContenido();
    ...
    private void registroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registroActionPerformed
        ...
        try {
            ...
            if (nombre.trim().length() > 0) {
                MapaProductos.addProducto(nombre, (float) numero);
                salida.setText("Se ha registrado el producto correctamente.");
                ingreso.setText("");
