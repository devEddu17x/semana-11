 ...
 * @author eduar
 */
public class ListaFrameProductos extends javax.swing.JFrame {

    /**
     * Creates new form ListasFrame
     */
    public ListaFrameProductos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Listas [Productos] by Eduardo");
    ...
    private void seleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionarActionPerformed
        ...
        if (index == 0) {
            ListaProductos.ordenarAs();
            listaContenidoOrdenar.setText(ListaProductos.getContenido());
        } else {
            ListaProductos.ordenarDes();
            listaContenidoOrdenar.setText(ListaProductos.getContenido());
        }
        ...
        try {
            ...
            if (numero > 0) {
                if (nombre.trim().length() > 0) {
                    ListaProductos.addProducto(new Producto(nombre, (float) numero));
    ...
    private void registro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registro1ActionPerformed
        String contenido = ListaProductos.getContenido();
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        if (nombre_buscar.trim().length() > 0) {
            Producto producto = ListaProductos.buscarNombre(nombre_buscar);
            if (producto != null){
    ...
    private void seleccionPrecioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionPrecioActionPerformed
        ...
        if (index == 0) {
            ListaProductos.ordenarAsPrecio();
            listaContenidoOrdenar2.setText(ListaProductos.getContenido());
        } else {
            ListaProductos.ordenarDesPrecio();
            listaContenidoOrdenar2.setText(ListaProductos.getContenido());
        }
...
//            java.util.logging.Logger.getLogger(ListaFrameProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ListaFrameProductos().setVisible(true);
//            }
//        });
//    }
